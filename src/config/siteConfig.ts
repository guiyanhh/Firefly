...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://mykichen.ohmychineselife.com",

	// 站点描述
	description:
		"这是一个专注分享中式美食的个人博客，收录家常小炒、传统名菜与地方特色菜。This is a personal blog dedicated to sharing authentic Chinese cuisine, covering home-style dishes, traditional classics and local specialties.",
